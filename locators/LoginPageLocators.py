...
class LoginPageLocators(object):
    ...
    email_error = (By.CSS_SELECTOR,
                   'div.form-field.form-field-error>span.error-bubble.error-bubble-twoliner')
    email_error_text = (By.CSS_SELECTOR,
                        'span.error-bubble.error-bubble-twoliner.span.error-msg')
